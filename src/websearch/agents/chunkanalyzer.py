"""Chunk analyzer agent module for web search operations.

This module provides an agent for analyzing text chunks.
"""
...
syste_prompt = SystemPrompt(
    ...
    dontdo=["Don't add considerations", "Don't alter the meaning of the text"],
)
...
class Response(BaseModel):
    ...
    response: str = Field(
        description="Summary of the text chunk. If not relevant, return 'not relevant'"
    )
